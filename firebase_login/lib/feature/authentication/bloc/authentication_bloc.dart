...
class AuthenticationBloc extends Bloc<AuthenticationEvent, AuthenticationState> {
  ...
  void _onSignedUp(AuthenticationSignedUp event, Emitter<AuthenticationState> emit) async {
    emit(AuthenticationLoading());
    try {
  ...
  void _onCheckRequested(AuthenticationCheckRequested event, Emitter<AuthenticationState> emit) async {
